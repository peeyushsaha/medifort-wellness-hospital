...
const adminStmt = db.prepare('INSERT OR IGNORE INTO users (name, email, phone, password_hash, role) VALUES (?, ?, ?, ?, ?)');
adminStmt.run('Admin', config.ADMIN.email, '+91-11-4567-8900', adminHash, 'admin');
